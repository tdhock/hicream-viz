...
print(viz.common)
system("du -ms figure-pixels-chr1-zoom-tiles-clusters-small")


if(FALSE){
  animint2pages(viz.common, "2025-10-09-HiC-pixels-chr1-zoom-tiles-clusters-small", chromote_sleep_seconds=5)
}
